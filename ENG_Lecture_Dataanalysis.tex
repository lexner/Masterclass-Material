...
\vspace{0.3cm}
\begin{center}
\begin{overpic}[width=1\textwidth]{Figures Lecture on Datanalysis/Histogram_Resoance.png} \put (30,-3){\scriptsize Variable} \put (0,40){\rotatebox[]{90}{\scriptsize Events}}\end{overpic}
\end{center}
           \end{minipage}
           \vspace{-2cm}
...
\scriptsize
    ...
    \draw (0,0) node [rounded corners=3pt, draw, fill=black, line width=0.1,text=white]   {\parbox{50pt}{\centering \vspace{10pt}\textbf{Neural network (NN)}\vspace{10pt}}} ;
