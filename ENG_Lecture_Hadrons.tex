...
\begin{align*}
    ...
    \end{cases} 
\end{align*} %\pause
 \tcbox[tcbox raise base]{\parbox{3cm}{Hadrons are colour-neutral}}\\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Can we Observe Single Quarks?}
...
% (m3l)-- [fermion, thick, in=-180, out=90] (b4nl),
  ...
  \end{feynman}
\end{tikzpicture} \\
The meson is pulled, when does it fly apart?
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Confinement}\addtocounter{framenumber}{-1}
%CONFINEMENT GRAFIK 
...
\begin{center}
     \tcbox[tcbox raise base]{\parbox{7cm}{A hadron with top flavour takes longer to form than the top quark decays.}}\\
   \end{center}
    \end{frame}
    \subsection{}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\subsection{}
\begin{frame}{Baryon Classification System}
\begin{center}
...
\end{minipage}
\end{frame}
\subsection{Picture: Janzen, 2009, edited}
\begin{frame}{Atomic Spectra}
...
\begin{minipage}{.49\textwidth}
\begin{itemize}
         \item Excitations in atoms %\pause
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Königsmann, 1986, edited}
\begin{frame}{States in the Charmonium Spectrum ($c\Bar{c}$)}
\begin{minipage}{.49\textwidth}
\begin{overpic}[width=1\textwidth,,tics=10]{Figures Lecture on Hadrons/ccBar_spectrum.png}
\put(40,-5){\scriptsize E$_\gamma$ in MeV}
\put(-2,35){\scriptsize \rotatebox[]{90}{Counts}}
...
\item \textcolor{red}{Spectra of hadrons are often complicated and unknown!}
